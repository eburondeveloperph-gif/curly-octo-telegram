...
export const generateSystemPrompt = (
  ...
  const getLanguageCode = (language: string) => {
    const codes: { [key: string]: string } = {
      ...
      'Burmese Sign Language': 'bzs',
      'Khmer Sign Language': 'csc',
      'Lao Sign Language': 'lso',
      'Vietnamese Sign Language': 'vso',
      'Mongolian Sign Language': 'msr',
      'Tibetan Sign Language': 'tss',
      'Uyghur Sign Language': 'uys',
      'Kazakh Sign Language': 'kzs',
      'Kyrgyz Sign Language': 'kgs',
      'Tajik Sign Language': 'tjs',
      'Turkmen Sign Language': 'tkm',
      'Uzbek Sign Language': 'uzs',
      'Azerbaijani Sign Language': 'azs',
      'Georgian Sign Language': 'gsg',
      'Armenian Sign Language': 'ase',
      'Afghan Sign Language': 'afg',
      'Iranian Sign Language': 'isg',
      'Iraqi Sign Language': 'iqs',
      'Lebanese Sign Language': 'lso',
      'Syrian Sign Language': 'ssy',
      'Jordanian Sign Language': 'jos',
      'Palestinian Sign Language': 'psl',
      'Egyptian Sign Language': 'esl',
      'Libyan Sign Language': 'lbs',
      'Tunisian Sign Language': 'tnd',
      'Algerian Sign Language': 'asq',
      'Moroccan Sign Language': 'msr',
      'Sudanese Sign Language': 'ssd',
      'Ethiopian Sign Language': 'eth',
      'Eritrean Sign Language': 'ers',
      'Djiboutian Sign Language': 'djs',
      'Somali Sign Language': 'soi',
      'Kenyan Sign Language': 'lso',
      'Ugandan Sign Language': 'ugn',
      'Tanzanian Sign Language': 'tza',
      'Rwandan Sign Language': 'rsl',
      'Burundian Sign Language': 'rbi',
      'Congolese Sign Language': 'scs',
      'Angolan Sign Language': 'aos',
      'Zambian Sign Language': 'zsl',
      'Malawian Sign Language': 'mfs',
      'Mozambican Sign Language': 'mzm',
      'Zimbabwean Sign Language': 'zsl',
      'Botswanan Sign Language': 'bqc',
      'Namibian Sign Language': 'nzs',
      'South African Sign Language': 'sas',
      'Lesotho Sign Language': 'lso',
      'Swazi Sign Language': 'swl',
      'Madagascar Sign Language': 'mcg',
      'Mauritian Sign Language': 'mcf',
      'Seychellois Sign Language': 'sls',
      'Comorian Sign Language': 'cnl',
      'Mayotte Sign Language': 'mfe',
      'Réunion Sign Language': 'rcp',
      'Chagos Sign Language': 'cgs',
      'Maldivian Sign Language': 'mdv',
      'Sri Lankan Sign Language': 'sli',
      'Indian Sign Language': 'ins',
      'Pakistani Sign Language': 'pks',
      'Bangladeshi Sign Language': 'bds',
      'Myanmar Sign Language': 'mfs',
      'Cambodian Sign Language': 'csc',
      'Laotian Sign Language': 'lso',
      'Indonesian Sign Language': 'inl',
      'Malaysian Sign Language': 'xml',
      'Bruneian Sign Language': 'bsl',
      'Singaporean Sign Language': 'sls',
      'Philippine Sign Language': 'psp',
      'East Timorese Sign Language': 'tst',
      'Papua New Guinean Sign Language': 'pgs',
      'Australian Aboriginal Sign Language': 'asw',
      'Fijian Sign Language': 'fjs',
      'Samoan Sign Language': 'ssl',
      'Tongan Sign Language': 'tsg',
      'Tuvaluan Sign Language': 'tvl',
      'Kiribati Sign Language': 'gil',
      'Marshallese Sign Language': 'mhl',
      'Palauan Sign Language': 'pau',
      'Micronesian Sign Language': 'mkp',
      'Northern Mariana Islands Sign Language': 'mso',
      'Guamanian Sign Language': 'gsl',
      'American Samoa Sign Language': 'asq',
      'Cook Islands Māori Sign Language': 'cim',
      'Niuean Sign Language': 'niu',
      'Tokelauan Sign Language': 'tkl',
      'Wallis and Futuna Sign Language': 'wls',
      'French Polynesian Sign Language': 'pfs',
      'New Caledonian Sign Language': 'ncl',
      'Vanuatuan Sign Language': 'vsl',
      'Solomon Islands Sign Language': 'sis'
    };
